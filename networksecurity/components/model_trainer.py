...
class ModelTrainer:
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        params = {
            ...
            "Gradient Boosting": {
                ...
                # "criterion": ["squared_error", "frideman_mse"],
        ...
        save_object(self.model_trainer_config.trained_model_file_path, obj=Network_Model) # saved as pickle file

        save_object("final_model/model.pkl", best_model) # here we can write other code to push the models into AWS
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            # loading training array and testing array: (dataset)
