...
class DataTransformation:
    ...
    def get_data_transfomer_object(cls)->Pipeline:
        """
            It intializes a KNN Imputer object with teh parameters specified in the training_pipeline.py files and return a pipeline object with the KNNimputer object as the first step.
            Args:
                cls: DataTrandformation
            Return:
                a Pipeline object
        """
        logging.info("entered get_data_transformer_object method of transformerclass")
        try:
            imputer:KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS) ## ** -> makes it key value 
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered initiate_data_transformation method of fataTransfromation class")
        try:
