...
from fastapi.templating import Jinja2Templates # responsible to load html files
...
async def predict_route(request: Request, file:UploadFile=File(...)):
    try:
        ...
        df.to_csv("prediction_output/output.csv") # here instead as saving locally we can save into mongodb/s3 bucket etc.
